...
public:
  ...
  virtual std::any visitUnaryMinus(AslParser::UnaryMinusContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitLogicalAnd(AslParser::LogicalAndContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitLogicalOr(AslParser::LogicalOrContext *ctx) override {
    return visitChildren(ctx);
  }
